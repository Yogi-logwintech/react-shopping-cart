...
export default function Header() {
  ...
  return (
    <div className="cart-header position-sticky">
        <NavLink style={{textDecoration: 'none', color:'white'}} to='/' ><h2>Shopping Cart</h2></NavLink>
        <div className="header-items">
          <NavLink className='link' to='/' >Home</NavLink>
          <NavLink className='link' to='/products' >Products</NavLink>
          <label type="button" className="position-relative">
